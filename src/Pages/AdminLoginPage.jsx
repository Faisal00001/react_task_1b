...
import { GlobalContext, showToast } from "../Provider/GlobalContext";
...
const AdminLoginPage = () => {
    ...
    const { dispatch: globalContext } = React.useContext(GlobalContext)
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            showToast(globalContext, "Logged in successfully!")
